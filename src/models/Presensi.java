...
//  Overloading construct..  
    public Presensi(String label, String data[]){
        initComponents();
        setStyle(label);
    ...
    private void setStyle(String label){
        if (label.equals("Tambah")){
            ...
            labelHadir.setForeground(new java.awt.Color(0,204,153));
            ...
            inputHadir.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0,204,153), 2));
        }
    }
    ...
    private void setFilled(String label, String data[]){
        if (label.equals("Ubah")){
            ...
            if (data[3].equals("1")){
                inputHadir.setSelectedIndex(0);
            }else if (data[3].equals("0")){
                inputHadir.setSelectedIndex(1);
            }
        }else if (label.equals("Tambah")){
            String id = Dashboard.getKode("Presensi", String.valueOf(lastId()));
            inputId.setText(id);
        }
    }
    ...
    private int lastId(){
        ...
        try{
            ...
            query = "SELECT MAX(id) FROM presensi";
    ...
    private void tambahData(){
        ...
        String presensi = unsetPresensi(String.valueOf(inputHadir.getSelectedIndex()));
        try{
            conn = Koneksi.getKoneksi();
            query = "INSERT INTO presensi (id, tgl_kerja, id_karyawan, kehadiran) VALUES (?,?,?,?)";
            ...
            if (pst.executeUpdate() > 0){
                ...
                this.dispose();
                Dashboard.getDataPanel(Dashboard.tabelPresensi);
            }else{
    ...
    private String unsetPresensi(String label){
        String pres = label.equals("0") ? "1" : "0";
        return pres;
    }
    ...
    private void ubahData(){
        ...
        String presensi = unsetPresensi(String.valueOf(inputHadir.getSelectedIndex()));
        try{
            query = "UPDATE presensi SET id_karyawan=?, kehadiran=? WHERE id=?";
            pst = conn.prepareStatement(query);
            pst.setString(1, idKrw);
            pst.setString(2, presensi);
            pst.setString(3, id);
            if (pst.executeUpdate() > 0){
    ...
    private void initComponents() {
        ...
        inputHadir = new javax.swing.JComboBox<>();
        ...
        storeTitle.setText("Data Presensi");
        ...
        labelWaktu.setText("Tanggal Kerja");
        ...
        labelHadir.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        labelHadir.setForeground(new java.awt.Color(51, 102, 255));
        labelHadir.setText("Kehadiran");
        ...
        inputHadir.setBackground(new java.awt.Color(35, 36, 54));
        inputHadir.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        inputHadir.setForeground(new java.awt.Color(245, 245, 250));
        inputHadir.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hadir", "Absen" }));
        inputHadir.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 102, 255), 2));
        inputHadir.setOpaque(false);
                        ...
                        .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, bgLayout.createSequentialGroup()
                                    .addComponent(labelHadir, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(inputHadir, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(bgLayout.createSequentialGroup()
        ...
        bgLayout.setVerticalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelHadir, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(inputHadir, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(48, 48, 48)
                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnSimpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSimpanMouseClicked
        if (storeTitle.getText().equals("Tambah Data Presensi")){
            tambahData();
        }else if (storeTitle.getText().equals("Ubah Data Presensi")){
            ubahData();
        }
    ...
    private javax.swing.JComboBox<String> inputHadir;
